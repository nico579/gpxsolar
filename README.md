...
```
The archive takes the architecture of the machine it is built on (`arm64` or
`x86_64`). PyInstaller does not cross-compile, so an Intel build requires an
Intel Mac (or Rosetta 2 with an x86_64 Python).
